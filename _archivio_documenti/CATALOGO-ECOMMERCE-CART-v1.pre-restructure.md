---
# Integrato da: 11-OUTPUT-ECOMMERCE-CART-CHECKOUT.md
# Data integrazione: 2026-01-29 14:51
# Generato con: Gemini 2.5 Flash / DeepSeek R1
---

Ecco i moduli CART e CHECKOUT completi, strutturati secondo le tue specifiche.

---

### FILE 1: prisma/schema-ecommerce-cart.prisma
...
### FILE 2: src/server/services/cart-service.ts
...
### FILE 3: src/server/services/checkout-service.ts
...
### FILE 4: src/server/trpc/routers/cart.ts
...
### FILE 5: src/server/trpc/routers/checkout.ts
...
### FILE 6: src/lib/validations/cart.ts
...
### FILE 8: src/hooks/use-checkout.ts
...
import { useRouter } from 'next/router'; // O 'next/navigation' per App Router
...
### FILE 9: src/components/cart/cart-drawer.tsx
...
### FILE 10: src/components/cart/cart-item.tsx
...
### FILE 11: src/components/cart/cart-summary.tsx
...
### FILE 12: src/components/cart/cart-icon.tsx
...
### FILE 13: src/components/checkout/checkout-form.tsx
...
### FILE 14: src/components/checkout/address-form.tsx
...
### FILE 15: src/components/checkout/shipping-options.tsx
