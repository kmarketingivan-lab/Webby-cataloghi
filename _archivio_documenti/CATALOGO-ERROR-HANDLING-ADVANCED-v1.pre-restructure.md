---
# Integrato da: 09-OUTPUT-MODULO-ERROR-HANDLING.md
# Data integrazione: 2026-01-29 14:51
# Generato con: Gemini 2.5 Flash / DeepSeek R1
---

Ecco il modulo completo per la gestione degli errori, strutturato come richiesto, con un'attenzione particolare all'error handling, alla resilienza e all'integrazione in un'applicazione moderna (es. Next.js con React Server Components e Client Components).

---

### FILE 1: src/lib/errors/base.ts
...
### FILE 2: src/lib/errors/codes.ts
...
### FILE 3: src/lib/errors/handler.ts
...
### FILE 4: src/lib/errors/logger.ts
...
### FILE 5: src/components/error-boundary.tsx
...
### FILE 8: src/app/global-error.tsx
...
### FILE 9: src/components/ui/error-alert.tsx
...
### FILE 10: src/hooks/use-error-handler.ts
...
### FILE 11: tests/error-handling.test.ts
