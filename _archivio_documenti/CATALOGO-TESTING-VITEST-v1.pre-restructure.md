---
# Integrato da: 18-OUTPUT-TESTING-COMPLETO.md
# Data integrazione: 2026-01-29 14:51
# Generato con: Gemini 2.5 Flash / DeepSeek R1
---

Assolutamente! Ecco il setup completo per il testing di un'applicazione Next.js con Vitest, Testing Library e Playwright, seguendo le tue specifiche e i requisiti di riga.

---

### FILE 1: vitest.config.ts (60 righe)
...
### FILE 2: tests/setup.ts (80 righe)
...
### FILE 3: tests/utils/test-utils.tsx (150 righe)
...
### FILE 4: tests/utils/mocks/prisma.ts (100 righe)
...
### FILE 5: tests/utils/mocks/trpc.ts (80 righe)
...
### FILE 6: tests/utils/mocks/stripe.ts (80 righe)
...
### FILE 7: tests/utils/mocks/api.ts (100 righe)
...
### FILE 8: tests/unit/services/auth-service.test.ts (200 righe)
...
### FILE 9: tests/unit/services/product-service.test.ts (200 righe)
...
### FILE 10: tests/unit/services/cart-service.test.ts (200 righe)
...
### FILE 11: tests/unit/services/order-service.test.ts (200 righe)
...
### FILE 12: tests/unit/hooks/use-cart.test.tsx (150 righe)
...
### FILE 13: tests/unit/components/button.test.tsx (100 righe)
...
### FILE 14: tests/unit/components/form.test.tsx (150 righe)
...
### FILE 15: tests/unit/components/product-card.test.tsx (100 righe)
...
### FILE 16: tests/integration/auth-flow.test.ts (200 righe)
...
### FILE 17: tests/integration/checkout-flow.test.ts (250 righe)
...
### FILE 18: tests/integration/api-routes.test.ts (200 righe)
