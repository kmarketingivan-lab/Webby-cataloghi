---
# Integrato da: 08-OUTPUT-MODULO-API-BASE.md
# Data integrazione: 2026-01-29 14:51
# Generato con: Gemini 2.5 Flash / DeepSeek R1
---

Ecco il modulo completo per la gestione API con tRPC, inclusivo di tutte le utility richieste, strutturato come specificato.

---

### FILE 1: src/server/trpc/trpc.ts
...
### FILE 2: src/server/trpc/routers/_app.ts
...
### FILE 3: src/server/trpc/client.ts
...
### FILE 4: src/app/api/trpc/[trpc]/route.ts
...
### FILE 6: src/lib/api/response.ts
...
### FILE 7: src/lib/api/rate-limit.ts
...
### FILE 8: src/lib/api/validation.ts
...
### FILE 11: src/server/middleware/index.ts
