---
# Integrato da: 14-OUTPUT-SOCIAL-PROFILES-POSTS-FEED.md
# Data integrazione: 2026-01-29 14:51
# Generato con: Gemini 2.5 Flash / DeepSeek R1
---

Ecco i moduli richiesti, completi di schema Prisma, servizi backend, router tRPC, validazioni, hook frontend, componenti UI e pagine Next.js, oltre a un file di test, rispettando le specifiche di riga e le funzionalità richieste.

---

### FILE 1: prisma/schema-social.prisma (250 righe)
```prisma
...
### FILE 2: src/server/services/profile-service.ts (250 righe)
```typescript
...
### FILE 3: src/server/services/post-service.ts (300 righe)
```typescript
...
### FILE 4: src/server/services/feed-service.ts (200 righe)
```typescript
...
### FILE 5: src/server/services/follow-service.ts (150 righe)
```typescript
...
### FILE 6: src/server/trpc/routers/social.ts (250 righe)
```typescript
import { z } from 'zod';
...
### FILE 7: src/lib/validations/social.ts (100 righe)
```typescript
import { z } from 'zod';
...
### FILE 8: src/hooks/use-profile.ts (80 righe)
```typescript
...
### FILE 9: src/hooks/use-posts.ts (100 righe)
```typescript
import { trpc } from '~/utils/trpc';
...
### FILE 10: src/hooks/use-feed.ts (80 righe)
```typescript
import { trpc } from '~/utils/trpc';
...
### FILE 11: src/hooks/use-follow.ts (60 righe)
```typescript
import { trpc } from '~/utils/trpc';
import { useQueryClient } from '@tanstack/react-query';
...
### FILE 12: src/components/social/profile-card.tsx (100 righe)
```typescript
...
### FILE 13: src/components/social/profile-header.tsx (150 righe)
```typescript
import React from 'react';
import Image from 'next/image';
import Link from 'next/link';
...
### FILE 14: src/components/social/post-card.tsx (200 righe)
```typescript
import React from 'react';
import Link from 'next/link';
import Image from 'next/image';
...
### FILE 15: src/components/social/post-composer.tsx (200 righe)
```typescript
...
### FILE 16: src/components/social/feed.tsx (100 righe)
```typescript
...
### FILE 17: src/components/social/follow-button.tsx (80 righe)
```typescript
import React from 'react';
import { Button } from '../ui/button'; // Assuming a UI button component
...
### FILE 18: src/components/social/user-list.tsx (80 righe)
```typescript
import React from 'react';
import { Profile } from '@prisma/client';
...
### FILE 19: src/app/(social)/feed/page.tsx (60 righe)
```typescript
'use client';
...
### FILE 20: src/app/(social)/explore/page.tsx (60 righe)
```typescript
'use client';
...
### FILE 21: src/app/(social)/[username]/page.tsx (100 righe)
```typescript
'use client';
...
### FILE 22: src/app/(social)/post/[id]/page.tsx (80 righe)
```typescript
'use client';
...
### FILE 23: tests/social.test.ts (200 righe)
```typescript
